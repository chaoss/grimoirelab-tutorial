...
The command above uses the `/override.cfg` file for the configuration of Mordred. In fact, this is the fourth configuration file in a chain of configuration files for Mordred. The order of configuration files matter, as values read in later configuration files will overwrite values read in earlier configuration files. Using this mechanism, you can set configuration specific to your instance using a single `/override.cfg` file. 
